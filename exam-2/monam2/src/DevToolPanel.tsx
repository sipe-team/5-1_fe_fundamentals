...
function readSnapshot(): MockSnapshot {
  ...
  return {
    roomCount: getStoredRooms().length,
    reservationCount: getStoredReservations().length,
      ...
      {isOpen ? (
        <aside style={panelStyle}>
          ...
          <div style={{ opacity: 0.85, marginBottom: 12 }}>
            rooms: {snapshot.roomCount} / reservations:{' '}
          ...
          <div style={{ display: 'grid', gap: 8 }}>
            ...
            <button
              type="button"
              onClick={() =>
                updateMockControls({ forceError: !snapshot.forceError })
              }
              style={{
                ...buttonStyle,
            ...
            <button
              type="button"
              onClick={() =>
                updateMockControls({ forceDelay: !snapshot.forceDelay })
              }
              style={{
                ...buttonStyle,
