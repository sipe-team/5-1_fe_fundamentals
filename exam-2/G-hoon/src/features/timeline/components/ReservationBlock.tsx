...
export default function ReservationBlock({
  ...
  return (
    ...
    >
      <button
        type="button"
        onClick={() => onClick(block.reservation.id)}
        className="w-full h-full bg-blue-500 text-white text-xs font-medium rounded px-2 py-1.5 truncate hover:bg-blue-600 transition-colors text-left"
      >
