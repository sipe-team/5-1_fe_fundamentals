...
Mock 데이터에는 총 **12개 메뉴**가 포함되어 있습니다.

| 카테고리 | 메뉴 수 | 예시                                                         |
| -------- | ------- | ------------------------------------------------------------ |
| 커피     | 4개     | 아메리카노, 화이트 아메리카노, 칠린 라떼, 바닐라 라떼        |
| 음료     | 3개     | 아이스티, 리프티, 딸기 우유                                  |
| 디저트   | 5개     | 블루베리 치즈케이크, 쿠키, 크로플, 레어 치즈케이크, 티라미수 |
...
| 4   | 추가옵션 | list   | X    | 바닐라 시럽(+300) / 헤이즐넛 시럽(+300) / 카라멜 시럽(+300) / 휘핑크림(+500) / 오트밀크(+500), 최대 3개 |
